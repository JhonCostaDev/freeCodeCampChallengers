...
### remainder
The **remainder** operator, represented by a percentage sign **(%)**, returns the remainder of a division. The remainder in math is the __leftover__ value after performing division:
